...
return [
    ...
    'base_url' => 'https://intuit-risks.iviou.ch',
    ...
    'auth' => [
        ...
        'in' => 'header', // or 'cookie' depending on your setup

        // The name of the auth parameter (eg token, key, apiKey) or header (eg Authorization, Api-Key).
        'name' => 'Authorization', // Use this if using headers for authentication

        // The value of the parameter to be used by Scribe to authenticate response calls.
        // This will NOT be included in the generated documentation. If empty, Scribe will use a random value.
        'use_value' => '', // Leave empty for a random value to be used in documentation.
...
INTRO,
    ...
    'groups' => [
        'default' => 'hidden', // or 'Endpoints' if you want a default group for ungrouped endpoints
        'order' => [],
    ],
